...
const ThemeSwitch = () => {
  ...
  return (
    ...
    >
      <svg
        className="absolute dark:translate-x-7 translate-x-0 transition-all duration-300 dark:rotate-45"
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
        viewBox="0 0 512 512"
      ...
      <svg
        className="absolute dark:translate-x-0 translate-x-7 transition-all duration-300 dark:rotate-0 rotate-45"
        stroke="currentColor"
        fill="currentColor"
        strokeWidth="0"
        viewBox="0 0 512 512"
